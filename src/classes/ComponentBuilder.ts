...
export class TMComponentBuilder {
  ...
  static selectMenu(
    ...
    custom_id: TowerMaidenInteractionInfo,
  ...
  addStringSelectMenu(
    ...
    const select: StringSelectMenuBuilder = TMComponentBuilder.selectMenu(
      "String",
      custom_id,
      placeholder_text,
      disabled,
  ...
  addRoleSelectMenu(
    ...
    const select: RoleSelectMenuBuilder = TMComponentBuilder.selectMenu(
      "Role",
      custom_id,
      placeholder_text,
      disabled,
  ...
  addChannelSelectMenu(
    ...
    const select: ChannelSelectMenuBuilder = TMComponentBuilder.selectMenu(
      "Channel",
      custom_id,
      placeholder_text,
      disabled,
  ...
  addMentionableSelectMenu(
    ...
    const select: MentionableSelectMenuBuilder = TMComponentBuilder.selectMenu(
      "Mentionable",
      custom_id,
      placeholder_text,
      disabled,
  ...
  addLinkButtonAccessorySection(
    ...
    const sec = TMComponentBuilder.section()
      .addTextDisplayComponents(TMComponentBuilder.textDisplay(content))
      .setButtonAccessory(
  ...
  addButtonAccessorySection(
    ...
    const sec = TMComponentBuilder.section().addTextDisplayComponents(
      TMComponentBuilder.textDisplay(content),
    );
    ...
    const but = TMComponentBuilder.accessoryButton(
      button_style,
      button_label,
      null,
      null,
  ...
  addFile(file_url_or_attachment?: string | Attachment): TMComponentBuilder {
    ...
    if (typeof file_url_or_attachment === "string") {
      ...
      file = TMComponentBuilder.fileItem(
